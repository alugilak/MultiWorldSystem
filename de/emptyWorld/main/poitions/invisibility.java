...
public class invisibility implements CommandExecutor
{
	einstellungen settings = einstellungen.getInstance();
	  ...
	  leerWelt plugin;   
  public invisibility( leerWelt instance)
  {
  ...
  if ((cmd.getName().equalsIgnoreCase("invisible"))){
	  if (!sender.hasPermission((String)this.settings.getpermData().get("mwsPoitions"))) {		
	        ...
	        return false;
              ...
              sender.sendMessage(ChatColor.RED + "Too few arguments! make /invisible <value> and or <playername> ");}else if(args.length < 2){      
	      int nv = Integer.parseInt(args[0]);
      PotionEffect effect = new PotionEffect(org.bukkit.potion.PotionEffectType.INVISIBILITY, Integer.MAX_VALUE, nv, true, false);
  ...
  PotionEffect effect1 = new PotionEffect(org.bukkit.potion.PotionEffectType.INVISIBILITY, Integer.MAX_VALUE, nv, true, false);
