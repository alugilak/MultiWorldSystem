...
public class nightvision implements CommandExecutor
{
	einstellungen settings = einstellungen.getInstance();
	  ...
	  leerWelt plugin;   
  public nightvision( leerWelt instance)
  {
  ...
  if ((cmd.getName().equalsIgnoreCase("nightvision"))){
	  if (!sender.hasPermission((String)this.settings.getpermData().get("mwsPoitions"))) {		
	        ...
	        return false;
              ...
              sender.sendMessage(ChatColor.RED + "Too few arguments! make /nightvision <value> and or <playername> ");}else if(args.length < 2){      
	      int nv = Integer.parseInt(args[0]);
      PotionEffect effect = new PotionEffect(org.bukkit.potion.PotionEffectType.NIGHT_VISION, Integer.MAX_VALUE, nv, true, false);
  ...
  PotionEffect effect1 = new PotionEffect(org.bukkit.potion.PotionEffectType.NIGHT_VISION, Integer.MAX_VALUE, nv, true, false);
