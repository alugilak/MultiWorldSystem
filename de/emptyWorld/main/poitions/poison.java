...
public class poison implements CommandExecutor
{
	einstellungen settings = einstellungen.getInstance();
	  ...
	  leerWelt plugin;   
  public poison( leerWelt instance)
  {
  ...
  if ((cmd.getName().equalsIgnoreCase("poison"))){
	  if (!sender.hasPermission((String)this.settings.getpermData().get("mwsPoitions"))) {		
	        ...
	        return false;
              ...
              sender.sendMessage(ChatColor.RED + "Too few arguments! make /poison <value> and or <playername> ");}else if(args.length < 2){      
	      int nv = Integer.parseInt(args[0]);
      PotionEffect effect = new PotionEffect(org.bukkit.potion.PotionEffectType.POISON, Integer.MAX_VALUE, nv, true, false);
  ...
  PotionEffect effect1 = new PotionEffect(org.bukkit.potion.PotionEffectType.POISON, Integer.MAX_VALUE, nv, true, false);
