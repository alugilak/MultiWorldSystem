...
public class speed implements CommandExecutor
{
	einstellungen settings = einstellungen.getInstance();
	  ...
	  leerWelt plugin;   
  public speed( leerWelt instance)
  {
  ...
  if ((cmd.getName().equalsIgnoreCase("speed"))){
      ...
      PotionEffect effect = new PotionEffect(org.bukkit.potion.PotionEffectType.SPEED, Integer.MAX_VALUE, nv, true, false);
  ...
  PotionEffect effect1 = new PotionEffect(org.bukkit.potion.PotionEffectType.SPEED, Integer.MAX_VALUE, nv, true, false);
