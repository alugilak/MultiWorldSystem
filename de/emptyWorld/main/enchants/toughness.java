...
public class toughness implements CommandExecutor {	
...
public toughness( leerWelt instance)
{
...
public boolean onCommand(CommandSender sender, Command cmd, String commandLabel, String[] args) { 
	Player p = (Player)sender;		  	    
	      if (commandLabel.equalsIgnoreCase("tough+")) {
	    	  if (!sender.hasPermission((String)this.settings.getpermData().get("mwsenchant")))
	        {
	    	  ...
	    	  if (args.length <= 1);{
	    		...
	    		toughness.set("AttributeName", new NBTTagString("generic.armorToughness"));
	    			...
	    			toughness.set("UUIDLeast", new NBTTagInt(894655));
	    			toughness.set("UUIDMost", new NBTTagInt(2873));
