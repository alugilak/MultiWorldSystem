...
public class atackkspeedanddamage implements CommandExecutor {	
...
public atackkspeedanddamage( leerWelt instance)
{
...
public boolean onCommand(CommandSender sender, Command cmd, String commandLabel, String[] args) { 
	Player p = (Player)sender;		  	    
	      if (commandLabel.equalsIgnoreCase("spdm+")) {
	    	  if (!sender.hasPermission((String)this.settings.getpermData().get("mwsenchant")))
	        {
	          ...
	          return false;
	 		     ...
	 		     ItemMeta itemmeta = item.getItemMeta();
	 		    		 itemmeta.setDisplayName(ChatColor.GOLD + (String)this.settings.getpData().get("ATTACK_SPEED_DisplayName_MYTHIC"));
	 		    		 itemmeta.setLore(Arrays.asList(((String)this.settings.getpData().get("ATTACK_SPEED_LORE"))));
	 		...
	 		speed.set("AttributeName", new NBTTagString("generic.attackSpeed"));
	 			...
	 			speed.set("Amount", new NBTTagInt(speed1));
	 			speed.set("Operation", new NBTTagInt(0));
	 			speed.set("UUIDLeast", new NBTTagInt(894656));
	 			speed.set("UUIDMost", new NBTTagInt(2874));
	 			speed.set("Slot", new NBTTagString("mainhand"));
	    		damage.set("AttributeName", new NBTTagString("generic.attackDamage"));    		
				damage.set("Name", new NBTTagString("generic.attackDamage"));    			
				damage.set("Amount", new NBTTagInt(dmg));    		
				damage.set("Operation", new NBTTagInt(0));    		
				damage.set("UUIDLeast", new NBTTagInt(894657));    		
				damage.set("UUIDMost", new NBTTagInt(2875));    			
				...
				modifiers.add(damage);    	
	 			...
	 			compound.set(((String)this.settings.getpData().get("ATTACK_SPEED_MYTHIC")), new NBTTagByte((byte) 1));
	 			nmsStack.setTag(compound);	    			
