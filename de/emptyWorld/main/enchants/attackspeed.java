...
public class attackspeed implements CommandExecutor {	
...
public attackspeed( leerWelt instance)
{
	      ...
	      if (commandLabel.equalsIgnoreCase("speed+")) {
	    	  ...
	    	  if (args.length < 1);{
	    		...
	    		speed.set("AttributeName", new NBTTagString("generic.attackSpeed"));
	    			...
	    			speed.set("UUIDLeast", new NBTTagInt(894653));
	    			speed.set("UUIDMost", new NBTTagInt(2871));
