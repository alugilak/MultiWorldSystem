...
World world;
	  ...
	  public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
  {
      ...
      sender.sendMessage(ChatColor.GREEN + "for Help in English, use this");
      sender.sendMessage(ChatColor.GOLD + " /mwshelp1" + ChatColor.LIGHT_PURPLE);
      sender.sendMessage(ChatColor.GOLD + " to" + ChatColor.LIGHT_PURPLE);
      sender.sendMessage(ChatColor.GOLD + " /mwshelp9" + ChatColor.LIGHT_PURPLE);
      sender.sendMessage(ChatColor.YELLOW + "********************************************************");
      sender.sendMessage(ChatColor.GREEN + "für eine Hilfe in Deutsch nutze");
      sender.sendMessage(ChatColor.GOLD + " /mwshelpDe1" + ChatColor.LIGHT_PURPLE);
      sender.sendMessage(ChatColor.GOLD + " bis" + ChatColor.LIGHT_PURPLE);
      sender.sendMessage(ChatColor.GOLD + " /mwshelpDe9" + ChatColor.LIGHT_PURPLE);
