...
World world;
	  ...
	  public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
  {
      ...
      sender.sendMessage(ChatColor.AQUA + " /mwshelp1 - /mwshelp10" + ChatColor.LIGHT_PURPLE);
      sender.sendMessage(ChatColor.AQUA + " /mwshelpDe1 - /mwshelpDe10" + ChatColor.LIGHT_PURPLE);
      sender.sendMessage(ChatColor.AQUA + " /mwsenchant - /mwsenchant3" + ChatColor.LIGHT_PURPLE);
      sender.sendMessage(ChatColor.AQUA + " /mwsenchantDe - /mwsenchantDe3" + ChatColor.LIGHT_PURPLE);
      sender.sendMessage(ChatColor.AQUA + " /mwspoition - /mwspoition1" + ChatColor.LIGHT_PURPLE);
      sender.sendMessage(ChatColor.AQUA + " /mwspoitionDe - /mwspoitionDe1" + ChatColor.LIGHT_PURPLE);
      sender.sendMessage(ChatColor.AQUA + " /pshelp" + ChatColor.LIGHT_PURPLE);
      sender.sendMessage(ChatColor.AQUA + " /pshelpDe" + ChatColor.LIGHT_PURPLE);
      sender.sendMessage(ChatColor.AQUA + "/mwsgroups" + ChatColor.LIGHT_PURPLE);
      sender.sendMessage(ChatColor.AQUA + "/mwsgroupsDe" + ChatColor.LIGHT_PURPLE);
      ...
      sender.sendMessage(ChatColor.YELLOW + "*********************************************************");
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("ItemBank1")));
      ...
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("mwwalkspeed21")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("mwwalkspeedHcmd")));
      sender.sendMessage(ChatColor.YELLOW + "*********************************************************");
      ...
      sender.sendMessage(ChatColor.YELLOW + "********************************************************");
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("mwsback1")));
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("mwsback2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("mwsbackcmd")));
      sender.sendMessage(ChatColor.YELLOW + "********************************************************");
      ...
      sender.sendMessage(ChatColor.YELLOW + "********************************************************");
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("mwskillallmobs1")));
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("mwskillallmobs2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("mwskillallmobscmd")));
      sender.sendMessage(ChatColor.YELLOW + "********************************************************");
      ...
      if (cmd.getName().equalsIgnoreCase("mwshelpDe10")) {			
          if (!sender.hasPermission((String) this.settings.getpermData().get("mwshelp"))) {
          	sender.sendMessage(ChatColor.GOLD.toString() + ChatColor.BOLD + ((String) this.settings.getsysoData().get("SystemName")) + ChatColor.GOLD.toString() + ChatColor.BOLD + " >" + ChatColor.BLUE + ((String) this.settings.getpermData().get("mwshelp")) + " " + ChatColor.GREEN + ((String) this.settings.getsysoData().get("permError")));
              return true;}
          sender.sendMessage(ChatColor.YELLOW + "*********************" + ChatColor.DARK_RED + ((String) this.settings.getdeData().get("helpmenuTitel10")) + ChatColor.YELLOW + "********************");
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("mwssavepos1")));
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("mwssavepos2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("mwssaveposcmd")));
      sender.sendMessage(ChatColor.YELLOW + "*********************************************************");
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("mwsloadpos1")));
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("mwsloadpos2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("mwsloadposcmd")));
      sender.sendMessage(ChatColor.YELLOW + "*********************************************************");
      ...
      if (cmd.getName().equalsIgnoreCase("mwsenchantDe")) {	
          sender.sendMessage(ChatColor.YELLOW + "****" + ChatColor.DARK_RED + ((String) this.settings.getdeData().get("helpmenuEnchantTitel")) + ChatColor.YELLOW + "****");
      sender.sendMessage(ChatColor.YELLOW + "*********************************************************");
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("ARROW_DAMAGE1")));
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("ARROW_DAMAGE2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("ARROW_DAMAGEcmd")));
      sender.sendMessage(ChatColor.YELLOW + "*********************************************************");
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("ARROW_FIRE1")));
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("ARROW_FIRE2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("ARROW_FIREcmd")));
      sender.sendMessage(ChatColor.YELLOW + "*********************************************************");
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("ARROW_INFINITE1")));
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("ARROW_INFINITE2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("ARROW_INFINITEcmd")));
      sender.sendMessage(ChatColor.YELLOW + "********************************************************");
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("ARROW_KNOCKBACK1")) + " " + ((String) this.settings.getdeData().get("mwsCommandSignH2")));
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("ARROW_KNOCKBACK2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("ARROW_KNOCKBACKcmd")));
      sender.sendMessage(ChatColor.YELLOW + "********************************************************");
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("FIRE_ASPECT1")));
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("FIRE_ASPECT2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("FIRE_ASPECTcmd")));
      sender.sendMessage(ChatColor.YELLOW + "*********************************************************");
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("DAMAGE_ALL1")));
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("DAMAGE_ALL2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("DAMAGE_ALLcmd")));
      sender.sendMessage(ChatColor.YELLOW + "*********************************************************");
      sender.sendMessage(ChatColor.GREEN + "/mwsenchant1 for more Help");
      sender.sendMessage(ChatColor.GREEN + "Please inform me" + ChatColor.YELLOW + " " + "if you found a bug" + " " + "https://www.spigotmc.org/threads/multiworldsystem-spigot-1-8.297346/");
      sender.sendMessage(ChatColor.YELLOW + "*********************************************************");}
      if (cmd.getName().equalsIgnoreCase("mwsenchantDe1")) {
          sender.sendMessage(ChatColor.YELLOW + "****" + ChatColor.DARK_RED + ((String) this.settings.getdeData().get("helpmenuEnchantTitel1")) + ChatColor.YELLOW + "****");
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("ATTACK_DAMAGE1")));
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("ATTACK_DAMAGE2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("ATTACK_DAMAGEcmd")));
      sender.sendMessage(ChatColor.YELLOW + "********************************************************");
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("ATTACK_DAMAGE_Speed1")));
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("ATTACK_DAMAGE_Speed2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("ATTACK_DAMAGE_Speedcmd")));
      sender.sendMessage(ChatColor.YELLOW + "********************************************************");
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("ATTACK_SPEED1")));
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("ATTACK_SPEED2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("ATTACK_SPEEDcmd")));
      sender.sendMessage(ChatColor.YELLOW + "********************************************************");
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("bootsArmorToughness1")));
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("bootsArmorToughness2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("bootsArmorToughnesscmd")));
      sender.sendMessage(ChatColor.YELLOW + "*********************************************************");
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("cheastArmorToughness1")));
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("cheastArmorToughness2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("cheastArmorToughnesscmd")));
      sender.sendMessage(ChatColor.YELLOW + "*********************************************************");
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("helmetArmorToughness1")));
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("helmetArmorToughness2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("helmetArmorToughnesscmd")));
      sender.sendMessage(ChatColor.YELLOW + "********************************************************");
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("legArmorToughness1")));
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("legArmorToughness2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("legArmorToughnesscmd")));
      sender.sendMessage(ChatColor.YELLOW + "*********************************************************");
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("Armor1")));
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("Armor2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("Armorcmd")));
      sender.sendMessage(ChatColor.YELLOW + "********************************************************");
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("Toughness1")));
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("Toughness2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("Toughnesscmd")));
      sender.sendMessage(ChatColor.YELLOW + "********************************************************");
      sender.sendMessage(ChatColor.YELLOW + "********************************************************");
      sender.sendMessage(ChatColor.GREEN + "I hope you have fun with this Plugin! (look at Help for /mwsPoition");
      sender.sendMessage(ChatColor.GREEN + "Please inform me" + ChatColor.YELLOW + " " + "if you found a bug" + " " + "https://www.spigotmc.org/threads/multiworldsystem-spigot-1-8.297346/");
      sender.sendMessage(ChatColor.YELLOW + "*********************************************************");}
      if (cmd.getName().equalsIgnoreCase("mwsenchantDe2")) {
          sender.sendMessage(ChatColor.YELLOW + "****" + ChatColor.DARK_RED + ((String) this.settings.getdeData().get("helpmenuEnchantTitel2")) + ChatColor.YELLOW + "****");
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("DAMAGE_ARTHROPODS1")));
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("DAMAGE_ARTHROPODS2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("DAMAGE_ARTHROPODScmd")));
      sender.sendMessage(ChatColor.YELLOW + "********************************************************");
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("DAMAGE_UNDEAD1")));
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("DAMAGE_UNDEAD2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("DAMAGE_UNDEADcmd")));
      sender.sendMessage(ChatColor.YELLOW + "********************************************************");
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("DIG_SPEED1")));
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("DIG_SPEED2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("DIG_SPEEDcmd")));
      sender.sendMessage(ChatColor.YELLOW + "*********************************************************");
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("DURABILITY1")));
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("DURABILITY2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("DURABILITYcmd")));
      sender.sendMessage(ChatColor.YELLOW + "*********************************************************");
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("KNOCKBACK1")));
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("KNOCKBACK2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("KNOCKBACKcmd")));
      sender.sendMessage(ChatColor.YELLOW + "********************************************************");
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("LOOT_BONUS_BLOCKS1")));
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("LOOT_BONUS_BLOCKS2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("LOOT_BONUS_BLOCKScmd")));
      sender.sendMessage(ChatColor.YELLOW + "*********************************************************");
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("LOOT_BONUS_MOBS1")));
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("LOOT_BONUS_MOBS2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("LOOT_BONUS_MOBScmd")));
      sender.sendMessage(ChatColor.YELLOW + "********************************************************");
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("LUCK1")));
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("LUCK2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("LUCKcmd")));
      sender.sendMessage(ChatColor.YELLOW + "********************************************************");
      sender.sendMessage(ChatColor.YELLOW + "********************************************************");
      sender.sendMessage(ChatColor.GREEN + "I hope you have fun with this Plugin! (look at Help for /mwsPoition");
      sender.sendMessage(ChatColor.GREEN + "Please inform me" + ChatColor.YELLOW + " " + "if you found a bug" + " " + "https://www.spigotmc.org/threads/multiworldsystem-spigot-1-8.297346/");
      sender.sendMessage(ChatColor.YELLOW + "*********************************************************");}
      if (cmd.getName().equalsIgnoreCase("mwsenchantDe3")) {
      sender.sendMessage(ChatColor.YELLOW + "****" + ChatColor.DARK_RED + ((String) this.settings.getdeData().get("helpmenuEnchantTitel3")) + ChatColor.YELLOW + "****");
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("LURE1")));
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("LURE2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("LUREcmd")));
      sender.sendMessage(ChatColor.YELLOW + "********************************************************");
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("MENDING1")));
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("MENDING2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("MENDINGcmd")));
      sender.sendMessage(ChatColor.YELLOW + "********************************************************");
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("OXYGEN1")));
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("OXYGEN2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("OXYGENcmd")));
      sender.sendMessage(ChatColor.YELLOW + "*********************************************************");
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("WATER_WORKER1")));
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("WATER_WORKER2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("WATER_WORKERcmd")));
      sender.sendMessage(ChatColor.YELLOW + "*********************************************************");
      sender.sendMessage(ChatColor.GREEN + "I hope you have fun with this Plugin! (look at Help for /mwsPoition");
      sender.sendMessage(ChatColor.GREEN + "Please inform me" + ChatColor.YELLOW + " " + "if you found a bug" + " " + "https://www.spigotmc.org/threads/multiworldsystem-spigot-1-8.297346/");
      sender.sendMessage(ChatColor.YELLOW + "*********************************************************");}  
      if (cmd.getName().equalsIgnoreCase("mwspoitionDe")) {	
          sender.sendMessage(ChatColor.YELLOW + "****" + ChatColor.DARK_RED + ((String) this.settings.getdeData().get("helpmenuPoitionTitel")) + ChatColor.YELLOW + "****");	            
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("DAMAGE_RESISTANCE1")));
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("DAMAGE_RESISTANCE2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("DAMAGE_RESISTANCEcmd")));
      sender.sendMessage(ChatColor.YELLOW + "********************************************************");
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("FAST_DIGGING1")));
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("FAST_DIGGING2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("FAST_DIGGINGcmd")));
      sender.sendMessage(ChatColor.YELLOW + "********************************************************");
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("NIGHT_VISION1")));
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("NIGHT_VISION2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("NIGHT_VISIONcmd")));
      sender.sendMessage(ChatColor.YELLOW + "********************************************************");
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("FIRE_RESISTANCE1")));
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("FIRE_RESISTANCE2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("FIRE_RESISTANCEcmd")));
      sender.sendMessage(ChatColor.YELLOW + "********************************************************");
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("CONFUSION1")));
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("CONFUSION2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("CONFUSIONcmd")));
      sender.sendMessage(ChatColor.YELLOW + "********************************************************");
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("ABSORPTION1")));
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("ABSORPTION2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("ABSORPTIONcmd")));
      sender.sendMessage(ChatColor.YELLOW + "********************************************************");
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("GLOWING1")));
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("GLOWING2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("GLOWINGcmd")));
      sender.sendMessage(ChatColor.YELLOW + "********************************************************");
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("REMOVE_POITION1")));
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("REMOVE_POITION2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("REMOVE_POITIONcmd")));
      sender.sendMessage(ChatColor.YELLOW + "********************************************************");
      sender.sendMessage(ChatColor.GREEN + "I hope you have fun with this Plugin!");
      sender.sendMessage(ChatColor.GREEN + "Please inform me" + ChatColor.YELLOW + " " + "if you found a bug" + " " + "https://www.spigotmc.org/threads/multiworldsystem-spigot-1-8.297346/");
      sender.sendMessage(ChatColor.YELLOW + "*********************************************************");
      return true;}
      if (cmd.getName().equalsIgnoreCase("mwspoitionDe1")) {	
          sender.sendMessage(ChatColor.YELLOW + "****" + ChatColor.DARK_RED + ((String) this.settings.getdeData().get("helpmenuPoitionTitel1")) + ChatColor.YELLOW + "****");	            
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("mwsbreathpoition1")));
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("mwsbreathpoition2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("mwsbreathpoitioncmd")));
      sender.sendMessage(ChatColor.YELLOW + "********************************************************");
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("mwsspeedpoition1")));
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("mwsspeedpoition2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("mwsspeedpoitioncmd")));
      sender.sendMessage(ChatColor.YELLOW + "********************************************************");
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("mwsregenerationpoition1")));
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("mwsregenerationpoition2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("mwsregenerationpoitioncmd")));
      sender.sendMessage(ChatColor.YELLOW + "********************************************************");
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("mwslevitationpoition1")));
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("mwslevitationpoition2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("mwslevitationpoitioncmd")));
      sender.sendMessage(ChatColor.YELLOW + "********************************************************");
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("mwsjumppoition1")));
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("mwsjumppoition2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("mwsjumppoitioncmd")));
      sender.sendMessage(ChatColor.YELLOW + "********************************************************");
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("mwsinvisiblepoition1")));
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("mwsinvisiblepoition2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("mwsinvisiblepoitioncmd")));
      sender.sendMessage(ChatColor.YELLOW + "********************************************************");
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("mwspoisonpoition1")));
      sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("mwspoisonpoition2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("mwspoisonpoitioncmd")));
      sender.sendMessage(ChatColor.YELLOW + "********************************************************");
      sender.sendMessage(ChatColor.GREEN + "I hope you have fun with this Plugin!");
      sender.sendMessage(ChatColor.GREEN + "Please inform me" + ChatColor.YELLOW + " " + "if you found a bug" + " " + "https://www.spigotmc.org/threads/multiworldsystem-spigot-1-8.297346/");
      sender.sendMessage(ChatColor.YELLOW + "*********************************************************");
      return true;}
if (cmd.getName().equalsIgnoreCase("mwsgroupsDe")) {	
sender.sendMessage(ChatColor.YELLOW + "****" + ChatColor.DARK_RED + ((String) this.settings.getdeData().get("helpmenuGroupsTitel")) + ChatColor.YELLOW + "****");	            
sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("addPermissionPlayer1")));
sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("addPermissionPlayer2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("addPermissionPlayercmd")));
sender.sendMessage(ChatColor.YELLOW + "********************************************************");
sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("removePermissionPlayer1")));
sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("removePermissionPlayer2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("removePermissionPlayercmd")));
sender.sendMessage(ChatColor.YELLOW + "********************************************************");
sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("addPermissionPlayerWorld1")));
sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("addPermissionPlayerWorld2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("addPermissionPlayerWorldcmd")));
sender.sendMessage(ChatColor.YELLOW + "********************************************************");
sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("removePermissionPlayerWorld1")));
sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("removePermissionPlayerWorld2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("removePermissionPlayerWorldcmd")));
sender.sendMessage(ChatColor.YELLOW + "********************************************************");
sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("addGroup1")));
sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("addGroup2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("addGroupcmd")));
sender.sendMessage(ChatColor.YELLOW + "********************************************************");
sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("deleteGroup1")));
sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("deleteGroup2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("deleteGroupcmd")));
sender.sendMessage(ChatColor.YELLOW + "********************************************************");
sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("setdefaultGroup1")));
sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("setdefaultGroup2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("setdefaultGroupcmd")));
sender.sendMessage(ChatColor.YELLOW + "********************************************************");
sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("setdefaultGroupWorld1")));
sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("setdefaultGroupWorld2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("setdefaultGroupWorldcmd")));
sender.sendMessage(ChatColor.YELLOW + "********************************************************");  
sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("mwspermaddgroup1")));
sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("mwspermaddgroup2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("mwspermaddgroupcmd")));
sender.sendMessage(ChatColor.YELLOW + "********************************************************");
sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("mwspermdelgroup1")));
sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("mwspermdelgroup2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("mwspermdelgroupcmd")));
sender.sendMessage(ChatColor.YELLOW + "********************************************************");
sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("mwspermaddgroupw1")));
sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("mwspermaddgroupw2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("mwspermaddgroupwcmd")));
sender.sendMessage(ChatColor.YELLOW + "********************************************************");
sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("mwspermdelgroupw1")));
sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("mwspermdelgroupw2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("mwspermdelgroupwcmd")));
sender.sendMessage(ChatColor.YELLOW + "********************************************************");
sender.sendMessage(ChatColor.GREEN + "I hope you have fun with this Plugin!");
sender.sendMessage(ChatColor.GREEN + "Please inform me" + ChatColor.YELLOW + " " + "if you found a bug" + " " + "https://www.spigotmc.org/threads/multiworldsystem-spigot-1-8.297346/");
sender.sendMessage(ChatColor.YELLOW + "*********************************************************");
return true;}
if (cmd.getName().equalsIgnoreCase("pshelpDe")) {	
sender.sendMessage(ChatColor.YELLOW + "****" + ChatColor.DARK_RED + ((String) this.settings.getdeData().get("mwsplayershopHelpTitel")) + ChatColor.YELLOW + "****");	            
sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("mwspscreate1")));
sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("mwspscreate2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("mwspscreatecmd")));
sender.sendMessage(ChatColor.YELLOW + "********************************************************");
sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("mwspssell1")));
sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("mwspssell2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("mwspssellcmd")));
sender.sendMessage(ChatColor.YELLOW + "********************************************************");
sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("mwspsremove1")));
sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("mwspsremove2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("mwspsremove1cmd")));
sender.sendMessage(ChatColor.YELLOW + "********************************************************");
sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("mwspsdelete1")));
sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("mwspsdelete2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("mwspsdeletecmd")));
sender.sendMessage(ChatColor.YELLOW + "********************************************************");
sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("mwssetshoptp1")));
sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("mwssetshoptp2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("mwssetshoptpcmd")));
sender.sendMessage(ChatColor.YELLOW + "********************************************************");
sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("mwsshoptp1")));
sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("mwsshoptp2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("mwsshoptpcmd")));
sender.sendMessage(ChatColor.YELLOW + "********************************************************");
sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("mwsdelshoptp1")));
sender.sendMessage(ChatColor.GREEN + ((String) this.settings.getdeData().get("mwsdelshoptp2")) + ChatColor.YELLOW + " " + ((String) this.settings.getdeData().get("mwsdelshoptpcmd")));
sender.sendMessage(ChatColor.YELLOW + "********************************************************");
